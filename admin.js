(() => {
  ...
  var scheduledComments = [];
  var inputElement;
  var deleteButton;
  var submitButton;
  var scheduledCommentInputElement;
  var scheduledTimeInputElement;
  var scheduledSubmitButton;
  var scheduledCommentListElement;
  function main() {
    initElements();
  ...
  function initElements() {
    ...
    scheduledCommentInputElement = document.getElementById("scheduled-comment-input");
    scheduledTimeInputElement = document.getElementById("scheduled-comment-time");
    scheduledSubmitButton = document.getElementById("scheduled-comment-submit");
    scheduledCommentListElement = document.getElementById("scheduled-comment-list");
  }
  function onSubmit() {
  ...
  function updateScheduledCommentList() {
    const sortedComments = Array.from(scheduledComments).sort((a, b) => a.date.getTime() - b.date.getTime());
    ...
    sortedComments.forEach((comment) => {
      ...
      scheduleDeleteButton.addEventListener("click", () => removeSchedule(comment));
  ...
  function watchScheduledComment() {
    setInterval(() => {
      ...
      scheduledComments = scheduledComments.filter((c) => !removeSchedules.includes(c));
      updateScheduledCommentList();
    }, 1e3);
  }
  function removeSchedule(targetComment) {
